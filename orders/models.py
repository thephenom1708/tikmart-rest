...
class Order(models.Model):
    billing_profile = models.ForeignKey(BillingProfile, related_name="orders", null=True, blank=True, on_delete=models.CASCADE)
    ...
    def get_absolute_url(self):
        return reverse("orders:detail", kwargs={"slug": self.slug})
...
def order_pre_save_receiver(sender, instance, *args, **kwargs):
    if not instance.slug:
        instance.slug = order_unique_slug_generator(instance)
